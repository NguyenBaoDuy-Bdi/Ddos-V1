...
def help(message):
    help_text = '''
-----------------------------------------------------
         Welcome to Alpha Power Bot DDOS
        To Start Bot Please Use Command !
-----------------------------------------------------
 - /attack [Methods] + [Host] : Attack To Target
-----------------------------------------------------
 - /methods : Show Full List Methods Layer 7 !
-----------------------------------------------------
 - /admin : Show Account Admin To ALPHA POWER
-----------------------------------------------------
 - /plan : Check Plan Attack YOU !
-----------------------------------------------------
 - /code + Link Wensite : Get Source Website Domain !
-----------------------------------------------------
'''
...
def methods(message):
    help_text = '''
-----------------------------------------------------
       This is the table of attack methods
   To view attack orders, please press '/attack'
       Attack ? " /attack + Methods + Host "
-----------------------------------------------------
 - HTTPS-FLOOD   | Vip : True
 - HTTPS-BYPASS  | Vip : Basic
 - TLS-KILLED    | Vip : Vip
 - DESTROY       | Vip : Non-Vip
-----------------------------------------------------
'''
...
def methods(message):
    help_text = '''
-----------------------------------------------------
Admin By : t.me/hulkdz207
Owner : t.me/hulkdz207
-----------------------------------------------------
Chanel Alpha C2 : t.me/AlplaC2
Zalo Admin : 0824117862
Grup Zalo : https://zalo.me/g/hnukjv833
-----------------------------------------------------
'''
    bot.reply_to(message, help_text)
