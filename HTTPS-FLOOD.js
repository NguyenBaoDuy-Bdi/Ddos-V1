const net = require("net");
 ...
 if (process.argv.length < 7){console.log(gradient.vice(`[!] node Fisher.js <HOST> <TIME> <RPS> <THREADS> <PROXY>.`));; process.exit();}
 const headers = {};
 ...
 console.log(gradient.vice(`[!] ĐANG TẤN CÔNG| Fisher | NHÌN BUỒI.`));
