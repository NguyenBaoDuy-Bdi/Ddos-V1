...
const accept_header = [
   ...
   'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.8',
   'image/*',
...
if (process.argv.length < 7){console.log(`node raw url time rq theard GET proxyfile`); process.exit();}
...
const secureProtocol = "TLS_client_method";"TLSv1_3_method";"TLSv1_2_method";
const headers = {};
...
if (cluster.isMaster) {
   ...
   console.clear()
   console.log(`--RAW ONLLY HTTP1.1/2/3 STRONG | VERSION: 1.2--`.rainbow)
   console.log(`-----------------------------------`.gray)
   console.log(` Target: `.brightYellow + process.argv[2].blue)
   console.log(` Theard: `.brightYellow + process.argv[5].blue)
   console.log(` Proxyfile: `.brightYellow + process.argv[7].blue)
   ...
   let headers = {
    ...
    Socker.HTTP(proxyOptions, (connection, error) => {
        ...
        const tlsOptions = {
           ...
           secure: true,
           ALPNProtocols: [
               "h2","http/1.1","spdy/3.1","h3","http/1.3","http/1.2"
           ],
           ciphers: ciphers,
           sigalgs: sigalgs,
           requestCert: true,
        ...
        const client = http2.connect(parsedTarget.href, {
           ...
           settings: {
               ...
               maxConcurrentStreams: 4000000,
               initialWindowSize: 6291456,
               maxHeaderListSize: 262144,
               enablePush: false
           },
           maxSessionMemory: 6555555,
